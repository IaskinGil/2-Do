...
GooglePlayServicesClient.ConnectionCallbacks, GooglePlayServicesClient.OnConnectionFailedListener
{
   ...
   private TextView addressLabel,locationLabel;
   private Button getLocationBtn, disconnectBtn, connectBtn, returnBtn, saveBtn;
   ...
   protected void onCreate(Bundle savedInstanceState) 
   {
      ...
      connectBtn.setOnClickListener(new View.OnClickListener() 
      {
         public void onClick(View view) 
         {
            ...
            locationLabel.setText("Got connected... Waiting for button press");
         }
      });
      
      returnBtn = (Button) findViewById(R.id.gps_return_button);
